...
function applyMotionPreference() {
  ...
  toggle.setAttribute('aria-label', paused ? 'Enable page animations' : 'Pause page animations');
  toggle.querySelector('.motion-label').textContent = paused ? 'Enable motion' : 'Pause motion';
